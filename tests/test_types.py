...
class TestType:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                types.Type(
                    inner=types.Type(inner=TYPE, volatile=True), lvalue_ref=True
                ),
                types.Type(inner=TYPE),
            ),
            (
                types.Type(
                    inner=types.Type(inner=TYPE, volatile=True), rvalue_ref=True
                ),
                types.Type(inner=TYPE),
            ),
            (
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ["const", TYPE, "&", "..."],
                types.Type(
                    inner=types.Type(inner=TYPE, const=True),
                    lvalue_ref=True,
                    parameter_pack=True,
                ),
            ),
            ([TYPE, "*"], types.Type(inner=TYPE, pointer=True)),
            ...
            (
                [TYPE, "*", "const", "&"],
                types.Type(
                    inner=types.Type(inner=TYPE, const=True, pointer=True),
                    lvalue_ref=True,
                ),
            ),
            (
            ...
            (
                [TYPE, "*", "&&", "..."],
                types.Type(
                    inner=types.Type(inner=TYPE, pointer=True),
                    rvalue_ref=True,
                    parameter_pack=True,
                ),
            ),
    ...
    @pytest.mark.parametrize(
        "type_, expected",
        [
            (types.Type(inner="T"), "T"),
            (types.Type(inner="T", lvalue_ref=True), "T &"),
            ...
            (
                types.Type(
                    inner=types.Type(inner="T", const=True),
                    lvalue_ref=True,
                    parameter_pack=True,
                ),
                "const T & ...",
            ...
            (
                types.Type(
                    inner=types.Type(inner="T", const=True, pointer=True),
                    lvalue_ref=True,
                ),
                "T * const &",
            ),
            (
                types.Type(inner=types.Type(inner="T", pointer=True), rvalue_ref=True),
                "T * &&",
            ),
            (
                types.Type(
                    inner=types.Type(inner="T", pointer=True),
                    rvalue_ref=True,
                    parameter_pack=True,
                ),
                "T * && ...",
            ...
            (
                types.Type(
                    inner=types.Type(inner="T", const=True), pointer=True, const=True
                ),
                "const T * const",
            ),
        ],
    ...
    @pytest.mark.parametrize(
        "tokens, const, volatile, spelling, expected",
        [
            ...
            (
                ...
                False,
                "",
                types.Type(inner=TYPE, const=True, pointer=True),
            ),
            (
                ["const", TYPE, "*"],
                False,
            ...
            (
                ...
                "foo",
                types.Type(
                    inner=types.Type(inner=TYPE, const=True), pointer=True, const=True
                ),
            ),
        ],
    )
...
class TestTemplateDecl:
    ...
    def test_from_node(self, mocker):
        template_type_param1 = mocker.Mock(
            get_tokens=mocker.Mock(return_value=["typename", "T"]),
            cursor=mocker.Mock(kind=clang.cindex.CursorKind.TEMPLATE_TYPE_PARAMETER),
            spec=translator.Node,
        )
        template_type_param2 = mocker.Mock(
            get_tokens=mocker.Mock(return_value=["typename", "...", "Ts"]),
            cursor=mocker.Mock(kind=clang.cindex.CursorKind.TEMPLATE_TYPE_PARAMETER),
            spec=translator.Node,
        )
        decoy = mocker.Mock(
            cursor=mocker.Mock(kind=clang.cindex.CursorKind.CXX_METHOD),
            spec=translator.Node,
        )
        parent = mocker.Mock(
            get_children=mocker.Mock(
                return_value=[template_type_param1, decoy, template_type_param2]
            )
        )
            ...
            (
                types.Method(
                    ...
                    params=[
                        ...
                        types.Type("float"),
                        types.Type(
                            inner="std::vector<double>", const=True, pointer=True
                        ),
                    ],
                    const=True,
                    virtual=True,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                types.Method(
                    ...
                    return_type=types.Type(
                        inner=types.Type("int", const=True), lvalue_ref=True
                    ),
                    const=True,
                    volatile=True,
                    noexcept=True,
            ...
            (
                ...
                types.Method(
                    name="f", params=[], return_type=types.Type("void"), virtual=True
                ),
            ),
            (
...
class TestVariable:
    @pytest.mark.parametrize(
        ...
        [
            (
                types.Variable("parameter_count", "int", [], False),
                "int parameter_count{};",
            ),
            (
                types.Variable("ptr", "std::shared_ptr<T>", ["t1", "t2"], True),
                "mutable std::shared_ptr<T> ptr{t1, t2};",
            ),
        ],
    )
...
class TestClass:
    @pytest.mark.parametrize(
        "name, enclosing_namespace, template_args, expected",
        [
    ...
    def test_full_name(
        self, name, enclosing_namespace, template_args, expected, mocker
    ):
        if template_args:
            ...
            template = None
        class_ = types.Class(
            name, enclosing_namespace=enclosing_namespace, template=template
        )
        ...
        [
            (
                types.Class(
                    "Dummy",
                    members=[
                        types.Method("f1", const=True, volatile=True),
    ...
    @pytest.mark.parametrize(
        "source, index, members, q_object, parent, template",
        [
            ...
            (
                ...
                1,
                [
                    types.TypeAlias("value_type", "T"),
                    types.Method("f", access="protected"),
                ],
                True,
                None,
                types.TemplateDecl(["T", "... Ts"]),
            ),
        ],
    )
    def test_from_node(self, source, index, members, q_object, parent, template):
        root = translator.translate(PATH, source, ["--std=c++11"])
        ...
        [
            ...
            (
                types.Class(
                    ...
                    members=[
                        mock.Mock(
                            __str__=mock.Mock(return_value="T value_;"),
                            access="private",
                        ),
                        mock.Mock(
                            __str__=mock.Mock(return_value="void f();"), access="public"
                        ),
                        mock.Mock(
                            __str__=mock.Mock(return_value="virtual void g();"),
                            access="protected",
                        ),
                    ],
                ),
            ...
            (
                types.Class(
                    ...
                    members=[
                        mock.Mock(
                            __str__=mock.Mock(return_value="T value_;"), access="public"
                        )
                    ],
                    final=True,
                    q_object=True,
...
class TestTypeAlias:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                types.TypeAlias(
                    "vector_type", "std::vector<T>", types.TemplateDecl(["T"])
                ),
