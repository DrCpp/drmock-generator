...
@pytest.mark.parametrize(
    "virtual_methods, access_specs, expected",
    [
        ([], None, []),
        (
            [
                types.Method(
                    name="g", return_type="int", virtual=True, access="protected"
                ),
                types.Method(name="g", return_type="int", params=["int"], virtual=True),
                types.Method(name="h", return_type="float", virtual=True),
                types.Method(
                    name="h", return_type="float", params=["int"], virtual=True
                ),
            ],
            None,
            [
                overload.Overload(
                    ...
                    [
                        types.Method(
                            name="g", return_type="int", params=["int"], virtual=True
                        )
                    ],
                ),
                overload.Overload(
        ...
        (
            [
                ...
                types.Method(
                    name="h", return_type="float", virtual=True, access="protected"
                ),
                types.Method(
                    name="h",
                    return_type="float",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                [
                    types.Method(
                        name="baz", params=[], const=True, return_type="const int&"
                    ),
                    types.Method(
                        name="baz",
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                [
                    types.Method(
                        name="DRMOCK_DISPATCHfoo",
                        params=[
                            types.Type(inner="::drmock::TypeContainer<::drmock::Const>")
                        ],
                        return_type=types.Type(inner="auto", lvalue_ref=True),
            ...
            (
                ...
                [
                    types.Method(
                        ...
                        params=[
                            types.Type(
                                inner="::drmock::TypeContainer<int, float, ::drmock::Const>"
                            )
                        ],
                        return_type=types.Type(inner="auto", lvalue_ref=True),
                        body="return *DRMOCK_METHOD_PTRfoo_0;",
            ...
            (
                ...
                [
                    ...
                    types.Method(
                        ...
                        params=[
                            types.Type(
                                inner="::drmock::TypeContainer<int, ::drmock::Const>"
                            )
                        ],
                        return_type=types.Type(inner="auto", lvalue_ref=True),
        ...
        [
            (
                ...
                [
                    types.Method(
                        ...
                        return_type=types.Type("int"),
                        body=(
                            "auto& result = *mock.bar().call(std::forward<int>(a0));\n"
            ...
            (
                [
                    types.Method(
                        name="operator<=",
                        params=[types.Type("int"), types.Type("int")],
                ...
                [
                    types.Method(
                        ...
                        override=True,
                        body=(
                            "auto& result = *mock.operatorLesserOrEqual().call(std::forward<int>(a0), std::forward<int>(a1));\n"
            ...
            (
                ...
                [
                    ...
                    types.Method(
                        ...
                        volatile=True,
                        body=(
                            "mock.template bar<::drmock::Const, ::drmock::Volatile>().call();"
                        ),
                    ),
                ],
            ),
            ...
            (
                ...
                [
                    types.Method(
                        ...
                        override=True,
                        body=(
                            "auto& result = *mock.template foo<int, const float &, std::vector<double> &&>().call(std::forward<int>(a0), std::forward<const float &>(a1), std::forward<std::vector<double> &&>(a2));\n"
                            "return std::forward<int &>(::drmock::move_if_not_copy_constructible(result));"
                        ),
                    ),
                    types.Method(
                        ...
                        override=True,
                        body=(
                            "auto& result = *mock.template foo<const float &, Ts && ..., ::drmock::Const>().call(std::forward<const float &>(a0), std::forward<Ts && >(a1)...);\n"
        ...
        [
            ...
            (
                ...
                [
                    ...
                    {
                        "mangled_name": mock.Mock(return_value="foo_mangled"),
                        "params": ["std::unordered_map<int, float>"],
                        "const": False,
                        "volatile": False,
                        "lvalue": False,
                        "rvalue": False,
