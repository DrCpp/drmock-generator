    ...
    @pytest.mark.parametrize('parent, kwargs, expected', [
        ('Foo',
         ...
         types.Method(name='foo',
                      ...
                      body='return foo_dispatch(::drmock::TypeContainer<DRMOCK_Ts ...>{});')),
        ('Foo',
         ...
         types.Method(
             ...
             return_type=types.Type(inner='auto', lvalue_ref=True),
             template=None,
             body='return foo_dispatch(::drmock::TypeContainer<int, float, ::drmock::Const>{});')),
        ('Foo',
         [{'mangled_name': mock.Mock(return_value='foo'), 'params': [], 'const': True, 'lvalue': False, 'rvalue': False},
         ...
         types.Method(name='foo',
                      return_type=types.Type(inner='auto', lvalue_ref=True),
                      template=types.TemplateDecl(['... DRMOCK_Ts']),
                      body='return foo_dispatch(::drmock::TypeContainer<DRMOCK_Ts ..., ::drmock::Const>{});')),
    ])
    ...
    @pytest.mark.parametrize('full_name, kwargs, expected', [
        ('Foo',
         ...
         [types.Variable(name='METHODS_DRMOCK_foo_0',
                         ...
                         default_args=[
                             'std::make_shared<::drmock::Method<Foo, int>>("", STATE_OBJECT_DRMOCK_)'],
                         access='private'),
          types.Variable(name='METHODS_DRMOCK_foo_1',
                         type='std::shared_ptr<::drmock::Method<Foo, int, float>>',
                         default_args=[
                             'std::make_shared<::drmock::Method<Foo, int, float>>("", STATE_OBJECT_DRMOCK_)'],
                         access='private')]),
        ('Bar',
         ...
         [types.Variable(name='METHODS_DRMOCK_bar_0',
                         ...
                         default_args=[
                             'std::make_shared<::drmock::Method<Bar, void, int, float>>("", STATE_OBJECT_DRMOCK_)'],
                         access='private')]),
        ('Baz',
         ...
         [types.Variable(name='METHODS_DRMOCK_baz_0',
                         ...
                         default_args=[
                             'std::make_shared<::drmock::Method<Baz, const int&>>("", STATE_OBJECT_DRMOCK_)'],
                         access='private'),
          types.Variable(name='METHODS_DRMOCK_baz_1',
                         type='std::shared_ptr<::drmock::Method<Baz, const int&, int>>',
                         default_args=[
                             'std::make_shared<::drmock::Method<Baz, const int&, int>>("", STATE_OBJECT_DRMOCK_)'],
                         access='private')]),
    ])
